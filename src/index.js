...
function generateRecipe(event) {
  ...
  let context =
    "You are a professional recipe expert and love to write creative recipes. Your mission is to generate a 10-line recipe in basic HTML, separating each step with <br />. Make sure to follow the user instructions. Do not include a title in the recipe.Ressults can appear in bullet point form. Sign the recipe with 'girl_arthope ai' in pink inside a <strong> element at the end of the recipe and NOT at the beginning.";
